    ...
    <div>
      ...
      <div className="p-4 md:p-8">
        <div className="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-black text-slate-900">Quản lý khoá</h1>
        ...
        <div className="mb-6 flex-1 flex items-center border border-[#0A4174] rounded-full px-3 py-3 hover:bg-blue-50 cursor-text">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="18px"
            height="18px"
